...
- See [config.md](config.md) for CLI defaults and settings ([auth.md](auth.md) for authentication)
...
For complete command documentation and all flags, see [commands/repo-commands.md](commands/repo-commands.md).
